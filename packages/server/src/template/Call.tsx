...
Array
(
    [7e47153db26367c75ef141eba6b59435] => 
    [proc] => call
    [ctrl] => remember
    [sub_ctrl] => 
    [cur_lang] => 1
...
*/}
    ...
    gtag('config', 'G-K1X5L7LJ8F');`}
      ...
      <link
        rel="stylesheet"
        type="text/css"
        href="./src/page/css/base.css.php?SN=525&amp;LG=1&amp;DD=6954a7346d8b8"
      />
      <link
        rel="stylesheet"
        type="text/css"
        href="./src/page/css/call.css?DD=6954a7346d8b9"
      />
      <link
        rel="stylesheet"
        type="text/css"
        href="./data/common/1/custom.css?DD=6954a7346d8c3"
      />
    ...
    <body>
        ...
        <div class="inner-wrap portrait">
          ...
          >
            ...
            <div id="header" class="float-clear">
              <h1 class="blinking">ご希望のボタンを押してください</h1>
            </div>
            ...
            <div id="footer">
              <ul id="menu">
                ...
                <li id="after-call" class="disabled selected">
                  <p>
                    店員
                    <br />
                    呼出
      ...
      <script
        type="text/javascript"
        src="./src/page/js/base.js.php?JS=call.js.php&amp;SN=525&amp;LG=1&amp;DD=6954a7346d8f3"
      ></script>
    </body>
  </html>
)
